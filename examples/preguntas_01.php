...
require_once './lib/html.formfile.class.php';
require_once './lib/CMailFile.class.php';
require_once './lib/html.formmail.class.php';
require_once './lib/html.formprojet.class.php';
require_once './lib/project.class.php';
require_once './lib/account.class.php';
require_once './lib/expensereport.lib.php';
require_once './lib/price.lib.php';
require_once './lib/expensereport/modules_expensereport.php';
require_once './lib/expensereport.class.php';
require_once './lib/paiement.class.php';
require_once './lib/doleditor.class.php';
